...
namespace PR.Data.Migrations
{
    ...
    [Migration("20190609004827_AddPatientWeightProperty")]
    partial class AddPatientWeightProperty
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PR.Data.Models.HCPCS", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PR.Data.Models.ICD10", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PR.Data.Models.IntakeForm", b =>
                {
                    ...
                    b.HasIndex("HCPCSId")
                        .IsUnique()
                        .HasFilter("[HCPCSId] IS NOT NULL");

                    b.HasIndex("ICD10Id")
                        .IsUnique()
                        .HasFilter("[ICD10Id] IS NOT NULL");
            ...
            modelBuilder.Entity("PR.Data.Models.IntakeForm", b =>
                {
                    ...
                    b.HasOne("PR.Data.Models.HCPCS", "HCPCS")
                        .WithOne("IntakeForm")
                        .HasForeignKey("PR.Data.Models.IntakeForm", "HCPCSId")
                        .HasConstraintName("FK_IntakeForm_HCPCS")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("PR.Data.Models.ICD10", "ICD10")
                        .WithOne("IntakeForm")
                        .HasForeignKey("PR.Data.Models.IntakeForm", "ICD10Id")
                    ...
                    b.HasOne("PR.Data.Models.Signature", "Signature")
                        .WithOne("IntakeForm")
                        .HasForeignKey("PR.Data.Models.IntakeForm", "SignatureId")
